...
async function createAlipayPayment(params: {
  ...
  try {
    ...
    const NOTIFY_URL = process.env.ALIPAY_NOTIFY_URL || process.env.NEXTAUTH_URL + '/api/payment/alipay/callback'
    const RETURN_URL = process.env.ALIPAY_RETURN_URL || process.env.NEXTAUTH_URL + '/payment/alipay/success'
