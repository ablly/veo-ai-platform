...
const faqs: FAQ[] = [
  {
    ...
    answer: "VEO AI 使用先进的AI模型将您的文字描述和参考图片转化为高质量视频。只需输入描述，可选上传参考图片（最多6张），AI将在30-60秒内生成视频。每次生成消耗5积分。"
  },
  {
    category: "使用指南",
    icon: Film,
  ...
  },
  {
    ...
    icon: CreditCard,
    question: "积分如何收费？",
    answer: "每次生成视频消耗5积分。新用户注册即送10积分（可生成2个视频）。购买积分套餐：基础套餐¥49/50积分，专业套餐¥149/200积分，企业套餐¥599/1000积分。"
  },
  {
    category: "积分系统",
    icon: CreditCard,
    question: "积分有效期多久？",
    answer: "免费赠送的积分有效期为30天，基础套餐积分30天，专业套餐90天，企业套餐180天。请在有效期内使用您的积分。"
  },
  {
    category: "积分系统",
    icon: CreditCard,
    question: "生成失败会退还积分吗？",
    answer: "是的！如果因技术问题导致生成失败，系统会自动退还消耗的积分。您无需手动申请，积分会立即返还到您的账户。"
  },
  {
    category: "视频管理",
    icon: Download,
  ...
  },
  {
    ...
    icon: Film,
    question: "可以批量生成视频吗？",
    answer: "可以。如有批量生成需求，建议购买企业套餐（1000积分/¥599）。每次仍需单独提交，但可以连续生成多个视频。"
  },
  {
    category: "故障排除",
    icon: HelpCircle,
    question: "视频生成失败怎么办？",
    answer: "如果生成失败，积分会自动退还。可能原因：1) 积分不足；2) 描述包含违规内容；3) 系统暂时故障。请检查积分余额，修改描述后重试，或稍后再试。"
  },
  {
    category: "故障排除",
    icon: HelpCircle,
