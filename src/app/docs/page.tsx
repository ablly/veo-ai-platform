...
const faqs: FAQ[] = [
  {
    ...
    answer: "VEO AI 使用先进的AI模型将您的文字描述和参考图片转化为高质量视频。只需输入描述，可选上传参考图片（最多6张），AI将在30-60秒内生成视频。每次生成消耗15积分。"
  },
  {
    category: "使用指南",
    icon: Film,
  ...
  },
  {
    ...
    icon: CreditCard,
    question: "积分如何收费？",
    answer: "每次生成视频消耗15积分。新用户注册即送10积分。购买积分套餐：基础套餐¥49/50积分，专业套餐¥99/150积分，企业套餐¥299/500积分。"
  },
  {
    category: "积分系统",
    icon: CreditCard,
  ...
  },
  {
    ...
    icon: CreditCard,
    question: "生成失败会退还积分吗？",
    answer: "是的！如果因技术问题导致生成失败，系统会自动退还消耗的积分（15积分）。您无需手动申请，积分会立即返还到您的账户。"
  },
  {
    category: "视频管理",
    icon: Download,
